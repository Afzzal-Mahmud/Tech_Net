...
export default function Checkout() {
  ...
  return (
    <div className="flex flex-col md:flex-row max-w-7xl mx-auto items-center border-b border-gray-300 gap-10 text-primary">
      <div className="max-w-3xl w-full md:w-[50%]">
        <h1 className="mb-2 text-xl md:text-3xl">Delivery Information</h1>
        <div className="h-[60vh] md:h-[70vh] border border-gray-300 rounded-md p-5 md:p-10 overflow-auto">
      ...
      <div className="max-w-lg w-full md:w-[50%]">
        <h1 className="mb-2 text-xl md:text-3xl">Order Summary</h1>
        <div className="border border-gray-300 rounded-md h-[60vh] md:h-[70vh] p-5 md:p-10 flex flex-col">
